...
namespace khiemnguyen.WebApi.Migrations
{
    ...
    [Migration("20231214085814_banuser")]
            ...
            modelBuilder.Entity("JWTAuth.WebApi.Models.UserInfo", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedDate = new DateTime(2023, 12, 14, 15, 58, 14, 210, DateTimeKind.Local).AddTicks(3276),
                            DisplayName = "abc",
                            Email = "abc@abc.com",
                            FullName = "API",
                            Password = "abc",
                        ...
                        {
                            UserId = 2,
                            CreatedDate = new DateTime(2023, 12, 14, 15, 58, 14, 210, DateTimeKind.Local).AddTicks(3345),
                            DisplayName = "Allen",
                            Email = "user@abc.com",
                            FullName = "Allen",
                            Password = "abc",
                        ...
                        {
                            UserId = 3,
                            CreatedDate = new DateTime(2023, 12, 14, 15, 58, 14, 210, DateTimeKind.Local).AddTicks(3348),
                            DisplayName = "Taro",
                            Email = "admin@abc.com",
                            FullName = "Taro",
                            Password = "abc",
                        ...
                        {
                            UserId = 4,
                            CreatedDate = new DateTime(2023, 12, 14, 15, 58, 14, 210, DateTimeKind.Local).AddTicks(3349),
                            DisplayName = "Jery",
