...
namespace khiemnguyen.WebApi.Migrations
{
    ...
    public partial class abc : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "UserInfo",
                columns: new[] { "UserId", "Address", "Answer", "CreatedDate", "DisplayName", "Email", "FullName", "Image", "Password", "PhoneNo", "Role", "StatusAccount", "UserName", "quationNo" },
                values: new object[,]
                {
                    { 1, null, null, new DateTime(2023, 12, 14, 20, 21, 50, 282, DateTimeKind.Local).AddTicks(6268), "abc", "abc@abc.com", "API", null, "abc", null, "Admin", false, "API", null },
                    { 2, null, null, new DateTime(2023, 12, 14, 20, 21, 50, 282, DateTimeKind.Local).AddTicks(6280), "Allen", "user@abc.com", "Allen", null, "abc", null, "Customer", false, "Allen", null },
                    { 3, null, null, new DateTime(2023, 12, 14, 20, 21, 50, 282, DateTimeKind.Local).AddTicks(6282), "Taro", "admin@abc.com", "Taro", null, "abc", null, "Admin", false, "Taro", null },
                    { 4, null, null, new DateTime(2023, 12, 14, 20, 21, 50, 282, DateTimeKind.Local).AddTicks(6284), "Jery", "caterer@abc.com", "Jery", null, "abc", null, "Caterer", false, "Jery", null }
                });
